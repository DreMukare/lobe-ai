			...
			content: (
				<>
					...
					<DropdownList
						list={[
							<p>
								<Link to={'/label'} style={{ color: 'black' }}>
									Label
								</Link>{' '}
								your examples
							</p>,
							<p>
								<Link to={'/train'} style={{ color: 'black' }}>
									Train
								</Link>{' '}
								a model
							</p>,
	...
	train: [
		{
			...
			content: (
				<>
					...
					<p>
						Read more{' '}
						<Link to={'/machine_learning'} style={{ color: 'black' }}>
					...
					<DropdownList
						list={[
							<p>
								Imported images to{' '}
								<Link
									to={'https://www.lobe.ai/docs/label/label'}
									style={{ color: 'black' }}
								>
									label as examples
								</Link>
			...
			content: (
				<>
					...
					<p>
						...
						<Link to={'/power_apps'} style={{ color: 'black' }}>
							Power Platform
						</Link>{' '}
						to use in Power Apps or Power Automate. You can also use the model
						files locally in your own app or in most major cloud platforms to
						create an API. Lobe also hosts your model as a local API to help
			...
			content: (
				<>
					...
					<DropdownList
						list={[
							<p>
								<Link to={'https://lobe.ai/'} style={{ color: 'black' }}>
									Website
								</Link>
							</p>,
							<p>
								<Link
									to={'https://www.twitter.com/lobe_ai'}
									style={{ color: 'black' }}
								>
									Twitter
								</Link>
							...
							<p>
								<Link
									to={'https://www.facebook.com/lobeai'}
									style={{ color: 'black' }}
								>
									Facebook
								</Link>
							...
							<p>
								<Link
									to={'https://www.reddit.com/r/lobe'}
									style={{ color: 'black' }}
								>
									Reddit
								</Link>
					...
					<p>
						Watch our{' '}
						<Link to={'https://aka.ms/LobeTour'} style={{ color: 'black' }}>
							intro tour
						</Link>
					</p>
				</>
